...
from model_triangle import DocREModel_Triangle
from utils import set_seed, collate_fn
from prepro import read_cdr, read_gda, read_biored
...
def main():
    ...
    parser.add_argument("--train_file", default="cdr_train.data", type=str)
    parser.add_argument("--dev_file", default="cdr_dev.data", type=str)
    parser.add_argument("--test_file", default="cdr_test.data", type=str)
    parser.add_argument("--load_path", default="", type=str)
    parser.add_argument("--save_path", default="saved_models/TriA-BioRE.pt", type=str)
    ...
    set_seed(args)
    model = DocREModel_Triangle(config, model, num_labels=args.num_labels)
    model.to(0)
